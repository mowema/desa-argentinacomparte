<?php
class My_Application_Resource_Translator extends Zend_Application_Resource_ResourceAbstract
{
    ...
    public function getTranslate()
    {
        ...
        $locale = $_COOKIE['lang']? $_COOKIE['lang']:$locale; 
        if($_GET['lang']) {
            $locale = $_GET['lang'];
            setcookie('lang', $_GET['lang'], 84000*365);
        }
$locale ='es_ARG'; 
