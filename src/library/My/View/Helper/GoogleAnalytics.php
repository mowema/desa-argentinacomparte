 ...
 * @copyright  Copyright (c) 2008 BaseZF * @author     Harold Thétiot (hthetiot)
 */
 
class My_View_Helper_GoogleAnalytics {
    /**
    ...
    public function __call($optionsName, $optionsArgs)
    {
        ...
        if (empty($optionsArgs)) {
            throw new Exception(
                'Missing TrackerId has first Argument on "$this->GoogleAnalytics->'
                . $optionsName . '()" function call'
            );
        }
