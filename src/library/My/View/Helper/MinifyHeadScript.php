 ...
 *
 */
class My_View_Helper_MinifyHeadScript extends My_View_Helper_MinifyFooterScript
{
    protected $_regKey = 'My_View_Helper_MinifyHeadScript';
    /**
     ...
     */
    public function minifyHeadScript ($mode = Zend_View_Helper_HeadScript::FILE, $spec = null, $placement = 'APPEND', 
    array $attrs = array(), $type = 'text/javascript')
    {
        return parent::minifyFooterScript($mode, $spec, $placement, $attrs, $type);
    }
}