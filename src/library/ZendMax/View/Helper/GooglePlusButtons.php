 ...
 * @author Ricardo
 */
class GooglePlusButtons extends \Zend_View_Helper_Abstract
{
    ...
    private $_dataAttribs = array(
        'size' => 'standard', // \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_SIZE_STANDARD
        'annotation' => 'bubble', // \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ANNOTATION_BUBBLE
        'align' => 'left',
        'expandTo' => ''
    );
    ...
    private $_allowedAligns = array(
        'left', // \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ALIGN_LEFT
        'right'// \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ALIGN_RIGHT
    );
    
    private $_allowedAnnotations = array(
        'none', // \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ANNOTATION_NONE
        'bubble', // \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ANNOTATION_BUBBLE
        'inline' //// \ZendMax\View\Helper\GooglePlusButtons::GOOGLE_PLUS_ANNOTATION_INLINE
    );
     ...
     * @return \ZendMax\View\Helper\GooglePlusButtons
     */
