 ...
 * @subpackage Helper
 */
class LateScript extends ScriptLoaderAbstract
{
    /**
     * Registry key for placeholder
     * @var string
     */
    protected $_regKey = 'ZendMax_View_Helper_lateScript';

    /**
     * Returns lateScript helper object; optionally, allows specifying a
    ...
    public function headScript($mode = \Zend_View_Helper_HeadScript::FILE, $spec = null, $placement = 'APPEND', array $attrs = array(), $type = 'text/javascript')
    {
        ...
        throw new \Zend_View_Exception(
            "You cannot call headScript from lateScript"
        );
    }
}
