 ...
 *
 */
class MinifyFooterScript extends \Zend_View_Helper_HeadScript
{
    /**
     * 
     ...
     * @var string
     */
    protected $_regKey = 'ZendMax_View_Helper_MinifyScriptAbstract';
     ...
     */
    public function minifyFooterScript(
    ...
    public function toString($indent = null)
    {
        ...
        foreach ( $this as $item ) {
            ...
            if (
                ...
                !empty($item->attributes ['src']) && preg_match('/https?:\/\//', $item->attributes ['src']) == false
            ) {
                ...
                if (count($scripts) > 0) {
                    ...
                    if (is_null($baseUrl) || $baseUrl == '') {
                        ...
                        $minScript->attributes ['src'] =
                            $this->getMinUrl() . '?b=' . $baseUrl . '&f=' . implode(',', $scripts);
                    }
