 ...
 *
 */
class FancyBox extends \Zend_View_Helper_Abstract
{
    const VERSION = '2.0.4';
    ...
    private $_options = array(
        ...
        'buttonsCss' => true,
        'title' => '',
        'template' => '<a href="%s" %s="%s" %s title="%s">%s</a>'
    );
    
    private static $_alreadyLoaded = array(
        'fancyBox' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/jquery.fancybox.pack.js?v=2.0.4',
            'type' => 'js'
        ),
        'mouseWheel' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/jquery.mousewheel-3.0.6.pack.js',
            'type' => 'js'
        ),
        'defaultCss' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/jquery.fancybox.css?v=2.0.4',
            'type' => 'css'
        ),
        'buttons' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/helpers/jquery.fancybox-buttons.js?v=2.0.4',
            'type' => 'js'
        ),
        'buttonsCss' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/helpers/jquery.fancybox-buttons.css?v=2.0.4',
            'type' => 'css'
        ),
        'thumbnail' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/helpers/jquery.fancybox-thumbs.js?v=2.0.4',
            'type' => 'js'
        ),
        'thumbnailCss' => array(
            'loaded' => false,
            'src' => '/js/lib/ZendMax/jquery/fancybox/helpers/jquery.fancybox-thumbs.css?v=2.0.4',
            'type' => 'css'
        )
    );
    ...
    {
        if (isset($options['options']['noConflict']) && $options['options']['noConflict'] == true) {
            $this->_noConflict = true;
            unset($options['options']['noConflict']);
        }
    ...
    private function _fancyCode()
    {
        ...
        // prepare <a> tag
        $extraClasses = (isset($this->_options['extraClasses']) && $selectorType != 'class')? 
            'class="' . $this->_options['extraClasses'] . '"' : '';
        $tpl = sprintf(
        ...
        $jQuery = $this->_noConflict? 'jQuery':'$';
        $this->view->footerScript()->appendScript(
<<<SCRIPT
{$jQuery}(function() {
...
HTML;
    ...
    /**
     * Checks if a js or css file has been loaded
     * @param string $option
     * @return boolean
     */
    public function isLoaded($option)
    {
        return self::$_alreadyLoaded[$option]['loaded'];
    }
