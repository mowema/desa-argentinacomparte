<?php
namespace Etermax\Paginator\Adapter;
...
class Doctrine implements \Zend_Paginator_Adapter_Interface
{
    ...
    {
        return \Etermax\Paginator\Paginate::createCountQuery($this->query);
    }
    ...
    {
        return \Etermax\Paginator\Paginate::createLimitSubQuery($this->query, $offset, $itemCountPerPage);
    }
    ...
    {
        return \Etermax\Paginator\Paginate::createWhereInQuery($this->query, $ids, $this->namespace);
    }
}
