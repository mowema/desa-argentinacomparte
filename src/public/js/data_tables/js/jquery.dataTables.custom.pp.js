$(document).ready(function() {
	$('#formatotabla').dataTable( {
		"sScrollY": "300px",
		"sDom": '<"top"fi<"toolbardt">>rt<"bottom"S',
		"bStateSave": true,
		"aaSorting": [[ 3, "desc" ]],
		"aoColumnDefs": [
			   { "bSortable": false, "bSearchable":false, "aTargets": [ 0,6 ]}
			   ],  		
	//	"sDom": '<"topdt"fi>rt<"bottom"lp<"clear">',
		"bPaginate": false,
	...
	$("div.toolbardt").html('<a href="/admin/agregar-politica-publica">crear nueva política pública</a>');
